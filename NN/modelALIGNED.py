"""Model builder for regression to align spectrum to its reference position."""
...
def buildModel(config, nfreq):
  #Defines the alignment model
    ...
    output = Dense(nfreq, activation = LeakyReLU(negative_slope = config['activation_dense1'] ))(dense_1)
